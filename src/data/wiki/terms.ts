...
export const getRelatedTerms = (currentSlug: string): WikiTerm[] => {
...
};
  {
    ...
    shortDefinition: 'Unidad central de procesamiento del servidor que ejecuta todas las operaciones de tu sitio web y determina su velocidad de respuesta.',
    longDefinition: `El CPU (Central Processing Unit) es el cerebro del servidor que procesa todas las solicitudes de tu sitio web. Un CPU más potente = respuestas más rápidas y mejor experiencia de usuario.

## ¿Por qué importa el CPU?

### **Tareas que procesa el CPU**
- Ejecución de código PHP/JavaScript
...
- **Frecuencia (GHz)**: Velocidad de reloj del procesador
- **Núcleos**: Cantidad de procesadores físicos
- **Threads**: Hilos de procesamiento simultáneo
- **Cache**: Memoria ultra-rápida integrada
- **Arquitectura**: x86_64, ARM, optimizaciones

## Tipos de hosting y CPU

### **Shared Hosting**
- **CPU compartido**: Entre múltiples cuentas
- **Límites por proceso**: Restricciones automáticas
- **Burst capability**: Picos temporales permitidos
- **Performance variable**: Depende de otros usuarios

### **VPS (Virtual Private Server)**
- **CPU dedicado**: Núcleos asignados exclusivamente
- **Recursos garantizados**: Sin compartir con otros
- **Escalabilidad**: Upgrade fácil de núcleos
- **Control total**: Sin limitaciones arbitrarias

### **Cloud Hosting**
- **CPU elástico**: Auto-scaling automático
- **Pay per use**: Pagas solo lo que usas
- **Balanceador**: Distribución inteligente de carga
- **High availability**: Múltiples servidores

## Monitoreo CPU en Chile

### **Métricas importantes**
- **CPU Load**: Carga promedio del sistema
- **CPU Usage**: Porcentaje de uso actual
- **Wait Time**: Tiempo esperando I/O
- **Process Queue**: Procesos en espera

### **Herramientas de monitoreo**
\`\`\`bash
# Comando básico para ver CPU usage
top
htop  # Más visual y amigable

# Load average - debe ser < número de CPUs
cat /proc/loadavg
...
# Monitoreo continuo
sar -u 1 60  # CPU cada segundo por 60 segundos
\`\`\`

### **Alertas automáticas**
- CPU >80% por 5+ minutos
- Load average >núcleos disponibles  
- Procesos consumiendo >50% CPU individual
- Queue length creciendo constantemente

## Optimización CPU para WordPress

### **Code-level optimizations**
- **Plugins cache**: W3 Total Cache, WP Rocket
- **Object cache**: Redis, Memcached
- **Database optimization**: Query optimization
- **Image processing**: Optimización automática
...
## Señales de CPU insuficiente

### **Síntomas en el sitio**
- ❌ Tiempo de carga >3 segundos
- ❌ Timeouts en formularios
- ❌ Errores 502/503 Gateway
- ❌ Admin de WordPress lento

### **Métricas del servidor**
- ❌ CPU load >número de cores
- ❌ CPU usage >90% sostenido
- ❌ High wait time (>20%)
- ❌ Process queue creciendo

## Planes CPU recomendados Chile

### **Sitio básico (blog/corporativo)**
- **1-2 vCPU**: Suficiente para <1000 visitas/día
- **Shared hosting**: Económico para comenzar
- **Burst**: Manejo de picos ocasionales

### **E-commerce mediano**
- **2-4 vCPU**: Para tiendas con inventario activo
- **VPS**: Recursos dedicados garantizados
- **SSD**: Reduce carga CPU en I/O

### **Sitio enterprise**
- **4-8+ vCPU**: Aplicaciones complejas
- **Dedicated server**: Máximo control y performance
- **Load balancer**: Distribución de carga

## Benchmarking CPU Chile

### **Herramientas de testing**
```bash
# CPU benchmark básico
sysbench cpu --cpu-max-prime=20000 run

# Test de stress completo
stress-ng --cpu 4 --timeout 60s --metrics-brief

# WordPress-specific load test
ab -n 1000 -c 10 http://tudominio.cl/
```

### **Métricas objetivo**
- **TTFB <200ms**: Time to First Byte
- **Page load <2s**: Carga completa de página
- **Concurrent users**: 100+ sin degradación
- **CPU efficiency**: <70% usage promedio`,
    category: 'hosting-fundamentals',
    cms: 'general',
    tags: ['cpu', 'procesador', 'performance', 'servidor'],
    level: 'medio',
    related: ['ram-memoria', 'vps', 'servidor-compartido'],
    hostingRequirements: ['CPU monitoring', 'Performance metrics', 'Auto-scaling'],
    cta: {
      plan: 'VPS Performance',
      copy: 'VPS con CPU dedicado y monitoreo avanzado incluido',
      url: 'https://clientes.hostingplus.cl/cart.php?a=add&pid=84'
    },
    proofPoints: ['CPU dedicado 100%', 'Monitoreo en tiempo real', 'Auto-scaling disponible'],
    whenToUse: 'Crítico para sitios con procesamiento intensivo o alto tráfico',
    synonyms: ['procesador', 'unidad central'],
    lastUpdated: '2025-01-15'
  },
  {
    id: 'hf-012',
    ...
    shortDefinition: 'Interfaz web que permite gestionar todos los aspectos de tu hosting: dominios, archivos, bases de datos, emails y configuraciones.',
    longDefinition: `El panel de control es la interfaz gráfica que te permite administrar tu hosting web sin necesidad de conocimientos técnicos avanzados. Es tu centro de comando para gestionar todo tu sitio.

## Tipos de paneles populares

### **cPanel**
- **Más usado mundialmente**: 70% market share
- **Interfaz intuitiva**: Iconos claros y organizados
- **Funciones completas**: File manager, email, databases
- **Third-party apps**: Softaculous, Cloudflare, etc.
- **Mobile friendly**: Responsive design

### **Plesk**
- **Orientado a desarrolladores**: Git integration, staging
- **Multi-server**: Gestión centralizada
- **Security focused**: ModSecurity, firewall integrado
- **Windows/Linux**: Soporte ambos sistemas
- **WordPress toolkit**: Gestión especializada WP

### **DirectAdmin**
- **Lightweight**: Consume menos recursos
- **Precio económico**: Licencia más barata
- **Simple**: Funcionalidades básicas bien ejecutadas
- **Stable**: Muy pocas caídas o bugs
- **Learning curve**: Menos intuitivo que cPanel

## Funcionalidades esenciales

### **Gestión de archivos**
- **File Manager**: Navegador web de archivos
- **FTP accounts**: Crear cuentas FTP/SFTP
- **Backup/Restore**: Copias de seguridad automáticas
- **Compression**: ZIP/TAR para archivos grandes
- **Permissions**: Control de permisos CHMOD

### **Base de datos**
- **MySQL databases**: Crear y gestionar DBs
- **phpMyAdmin**: Interfaz web para MySQL
- **Database users**: Control de acceso granular
- **Import/Export**: Migración de datos fácil
- **Optimization**: Tools de optimización automática

### **Email management**
- **Email accounts**: Crear cuentas ilimitadas
- **Forwarders**: Redirección de emails
- **Autoresponders**: Respuestas automáticas
- **Webmail**: Acceso web (Roundcube, Horde)
- **Spam filtering**: Protección antispam integrada

### **Dominios y subdominios**
- **Addon domains**: Múltiples dominios por cuenta
- **Subdomains**: Crear subdominios ilimitados
- **DNS management**: Editor de zona DNS
- **Redirects**: Redirecciones 301/302
- **SSL/TLS**: Certificados automáticos

## Paneles en hosting chileno

### **Proveedores que usan cPanel**
```
HostingPlus:
├── cPanel incluido en todos los planes
├── Softaculous con 400+ apps
...
NetHosting:
├── cPanel + Plesk opciones
├── Developer tools incluidos
├── Git deployment
├── Staging sites
└── Advanced security tools
```

### **Características específicas Chile**
- **Idioma español**: Interfaz localizada
- **Timezone**: Configurado para Chile/Santiago
- **Currency**: Pesos chilenos en reportes
- **Support**: Chat/tickets en español
- **Local backups**: Servidores en Chile

## Automatización desde panel
...
# Optimización DB semanal los domingos
0 3 * * 0 /usr/bin/mysql -e "OPTIMIZE TABLE wp_posts,wp_options"

# Limpieza cache cada hora
0 * * * * /usr/bin/find /tmp/cache -type f -mtime +1 -delete
```

### **Auto-installers populares**
- **WordPress**: 1-click install + auto-updates
- **WooCommerce**: E-commerce setup completo
- **Joomla**: CMS alternativo con extensions
- **Drupal**: CMS enterprise-grade
- **PrestaShop**: E-commerce español-friendly

## Seguridad del panel

### **Best practices**
- **Strong passwords**: Usar password manager
- **2FA**: Two-factor authentication siempre
- **IP restrictions**: Limitar acceso por IP
- **Session timeout**: Logout automático
- **Regular updates**: Panel y apps actualizadas
...
├── IP blocks automáticos
├── Malware scan results
├── SSL certificate status
└── Firewall activity
```

## Migración entre paneles

### **cPanel → Plesk**
- **Migration tool**: Plesk migrator automático
- **Downtime**: 2-4 horas típicamente
- **Compatibility**: 95% funciones transferibles
- **Testing**: Staging environment recomendado

### **DirectAdmin → cPanel**
- **Manual process**: Requiere asistencia técnica
- **Data export**: Backup completo previo
- **DNS propagation**: 24-48 horas
- **Training**: Familiarización con nueva interfaz

## Troubleshooting común

### **Panel no carga**
```bash
# Verificar servicio Apache/Nginx
...
- **Disable extensions**: Ad blockers pueden interferir
- **Try different browser**: Chrome vs Firefox
- **Check PHP version**: Compatibility issues
- **Contact support**: Si persiste el problema`,
    category: 'hosting-fundamentals',
    cms: 'general',
    tags: ['cpanel', 'panel-control', 'gestion-hosting', 'interfaz'],
    level: 'basico',
    related: ['ftp', 'base-datos', 'ssl-certificados'],
    hostingRequirements: ['cPanel/Plesk incluido', 'Auto-installers', 'File manager'],
    cta: {
      plan: 'Hosting con cPanel',
      copy: 'Hosting con cPanel incluido y auto-installers premium',
      url: 'https://clientes.hostingplus.cl/cart.php?a=add&pid=81'
    },
    proofPoints: ['cPanel incluido', 'Softaculous premium', 'Soporte en español'],
    whenToUse: 'Esencial para gestionar hosting sin conocimientos técnicos',
    synonyms: ['cpanel', 'plesk', 'administración hosting'],
    lastUpdated: '2025-01-15'
  },

  // Additional Domains Term
  {
    id: 'dom-007',
    slug: 'transferencia-dominio',
    title: 'Transferencia de Dominio',
    shortDefinition: 'Proceso de cambiar el registrador de un dominio de una empresa a otra, manteniendo la propiedad y configuración DNS.',
    longDefinition: `La transferencia de dominio permite cambiar el registrador (empresa que gestiona tu dominio) sin perder la propiedad ni afectar el funcionamiento del sitio web.

## ¿Cuándo transferir un dominio?

### **Razones comunes**
- **Mejor precio**: Registradores más económicos
- **Mejor soporte**: Atención al cliente superior
- **Consolidation**: Unificar dominios en un lugar
- **Features**: Panel de control más avanzado
- **Hosting combo**: Dominio + hosting en un proveedor

### **Momento ideal**
- **Mínimo 60 días**: Después del registro inicial
- **Antes expiración**: Al menos 30 días de margen
- **Fuera de renovación**: Evitar complicaciones
- **DNS estable**: Sin cambios recientes

## Proceso de transferencia

### **Preparación (Registrador actual)**
1. **Unlock domain**: Quitar protection lock
2. **Get EPP/Auth code**: Código de autorización
3. **Verificar email**: Contacto administrativo actualizado
4. **Disable privacy**: WHOIS privacy temporalmente off
5. **Check expiration**: Dominio vigente mínimo 60 días

### **Iniciación (Nuevo registrador)**
1. **Transfer request**: Solicitar transferencia
2. **EPP code**: Ingresar código de autorización
3. **Verification email**: Confirmar en email registrante
4. **Payment**: Pagar año adicional (extenderá vigencia)
5. **Wait**: 5-7 días proceso automático

### **Confirmación**
- **Transfer approval**: Email de aprobación
- **DNS preservation**: Nameservers mantenidos
- **Whois update**: Nuevo registrar visible
- **Access**: Login en nuevo panel control

## Transferencia dominios .CL

### **Proceso NIC Chile**
```
Requisitos específicos .CL:
├── Formulario NIC Chile firmado
├── Cédula de identidad (persona natural)
├── RUT vigente (empresa)
├── Poder notarial (si representa empresa)
└── Pago tasas NIC Chile
```

### **Documentación requerida**
- **Persona natural**: Cédula identidad vigente
- **Empresa**: Certificado RUT + poder notarial
- **Representante**: Autorización notarial específica
- **Contactos**: Actualizar datos antes transferencia

### **Timeframe .CL**
- **Documentación**: 1-3 días hábiles revisión
- **Aprobación NIC**: 2-5 días hábiles
- **Total process**: 5-10 días hábiles
- **Rush service**: Disponible por costo adicional

## Transferencias internacionales

### **Dominios .COM/.NET/.ORG**
```bash
# Timeline típico transferencia
Day 0: Transfer initiated
Day 1: EPP code verified
Day 2-3: Registrant confirmation email
Day 4-5: Losing registrar approval window
Day 6-7: Transfer completion
```

### **Auto-approval**
- **No response**: Auto-aprueba en 5 días
- **Explicit approval**: Acelera proceso
- **Explicit denial**: Cancela transferencia
- **Invalid EPP**: Rechaza inmediatamente

## Aspectos técnicos

### **DNS durante transferencia**
```
❗ IMPORTANTE:
├── Nameservers se mantienen
├── DNS records preserved
├── Email continúa funcionando
├── Website no afectado
└── Solo cambia registrar management
```

### **Configuraciones que se mantienen**
- **DNS settings**: Todas las entradas A, CNAME, MX
- **Email routing**: Configuración de correo
- **Subdomains**: Todos los subdominios
- **SSL certificates**: No afectados por transferencia

### **Lo que puede cambiar**
- **Management panel**: Nuevo interfaz control
- **API access**: Endpoints diferentes
- **Pricing**: Renovación a nuevas tarifas
- **Features**: Funcionalidades panel nuevo registrar

## Costos transferencia Chile

### **Dominios .CL**
```
NIC Chile fees:
├── Persona natural: $8.000 + IVA
├── Empresa: $15.000 + IVA  
├── Trámite urgente: +50% fee
└── Cambio documentos: $5.000 adicional

Registrar fees:
├── Gestión: $10.000-25.000
├── Setup: Generalmente gratis
├── Support: Incluido primer año
└── Renewal: Según nueva tarifa
```

### **Dominios internacionales**
```
Transfer costs:
├── .COM: $12-15 USD (extiende 1 año)
├── .NET: $13-16 USD (extiende 1 año)
├── .ORG: $14-17 USD (extiende 1 año)
├── Setup fee: $0-5 USD
└── Privacy: $5-10 USD/año opcional
```

## Problemas comunes y soluciones

### **Transferencia rejected**
- **EPP code invalid**: Solicitar nuevamente
- **Domain locked**: Unlock en registrar actual
- **Email not confirmed**: Check spam folder
- **Recent changes**: Wait 60 days desde cambios

### **Transfer delays**
```bash
# Check transfer status
whois domain.com | grep -i "transfer"

# Verify nameservers haven't changed
dig NS domain.com

# Check if domain locked
whois domain.com | grep -i "lock\|status"
```

### **DNS issues post-transfer**
- **Wait propagation**: 24-48 hours DNS update
- **Verify nameservers**: Should remain same
- **Check TTL values**: Lower TTL acelera changes
- **Contact support**: Si issues persisten >48hrs

## Best practices

### **Timing**
- **Avoid expiration**: Transfer 30+ días antes vencimiento
- **Business hours**: Iniciar lunes-miércoles
- **Season avoid**: No durante Black Friday/holidays
- **Communication**: Notificar a equipo IT

### **Documentation**
- **EPP code**: Guardar securely
- **Screenshots**: Panel settings antes transferencia
- **Contact info**: Backup de datos contacto
- **DNS records**: Export complete zone file

### **Testing post-transfer**
```bash
...
````,
    category: 'domains',
    cms: 'general',
    tags: ['transferencia-dominio', 'cambio-registrador', 'migracion'],
    level: 'medio',
    related: ['whois', 'dns', 'nameservers'],
    hostingRequirements: ['Domain management', 'EPP support', 'Transfer assistance'],
    cta: {
      plan: 'Domain Transfer',
      copy: 'Transferencia gratuita de dominios con soporte completo',
      url: 'https://clientes.hostingplus.cl/cart.php?a=add&pid=90'
    },
    proofPoints: ['Transferencia gratuita', 'Soporte especializado', 'Sin downtime garantizado'],
    whenToUse: 'Para consolidar dominios o obtener mejor servicio/precio',
    synonyms: ['cambio registrador', 'migración dominio'],
    lastUpdated: '2025-01-15'
  }
];
