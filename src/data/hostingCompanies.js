...
// Versión JavaScript (ESM) de hostingCompanies para el script de sitemap
// Contiene los mismos datos que hostingCompanies.ts

export const hostingCompanies = {
  "hostingplus": {
    id: "hostingplus",
    name: "HostingPlus.cl",
  ...
  // Agrega aquí los demás proveedores actuales...
  "1hosting": {
    id: "1hosting",
    name: "1Hosting.cl",
  ...
  // ... todos los demás proveedores que ya existen

  // A continuación, añadimos algunos nuevos proveedores para el sitemap:
  // "wildhost": { ... },
  // ... etc.
};
