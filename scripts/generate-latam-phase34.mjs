...
async function generateDatosPage() {
  ...
  await fs.writeFile('public/datos/index.html',
    buildHtml({ title, description, canonical, locale: 'es', headExtra, bodyContent: body, keywords: 'datos abiertos hosting, benchmarks hosting latam, cc-by-4.0, api hosting', ogImage: 'https://eligetuhosting.com/og/datos.png' }), 'utf8');
